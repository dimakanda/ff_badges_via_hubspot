...
ActiveRecord::Schema.define(version: 20141222162021) do
  ...
  add_index "activities", ["user_id", "trackable_id"], name: "index_activities_on_user_id_and_trackable_id", using: :btree
  ...
  create_table "badges", force: true do |t|
    ...
    t.text     "external_earned_description"
    t.text     "external_unearned_description"
  ...
  add_index "users", ["new_email_token"], name: "index_users_on_new_email_token", using: :btree
